...
const AboutItem = (data)=>
{
    return(
        ...
        <div className="w3-col m6 w3-padding-large w3-hide-small">
         <img src="https://www.w3schools.com/w3images/tablesetting2.jpg" className="w3-round w3-image w3-opacity-min" />
        </div>
        <div className="w3-col m6 w3-padding-large">
          <h1 className="w3-center">{data.heading1}</h1><br/>
          <h5 className="w3-center">{data.heading2}</h5>
          <p className="w3-large">{data.description1} <span class="w3-tag w3-light-grey">seasonal</span> ingredients.</p>
